        ...
        v = function(b) {
            ...
            this.publish = function(a, b, e, d) {
                if (this.topics[a]) {
                    var c = this.topics[a],
                        ...
                        p, q, u, A;
                    q = 0;
                    for (u = c.length; q < u; q++) A = c[q], p = A[0], A[1] && (A[0] = function() {}, f.push(q)), g.push(p);
                    q = 0;
            ...
            this.unsubscribe = function(a) {
                if (this.topics[a.topic])
                    for (var b = this.topics[a.topic], e = 0, d = b.length; e < d; e++) b[e] && b[e][0] === a.callback && b.splice(e, 1)
            }
        },
