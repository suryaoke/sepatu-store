 ...
 @section('backend')
                     ...
                     <table id="datatable" class="table table-bordered table-hover">
                         <thead>
                             <tr>
                                 ...
                                 <th class="whitespace-nowrap">Kode Voucher</th>
                                 <th class="whitespace-nowrap">Potongan</th>
                                     ...
                                     <div class="modal-dialog">
                                         <div class="modal-content"> <!-- BEGIN: Modal Header -->
                                             <div class="modal-header">
                                                 <h2 class="font-medium text-base mr-auto">Ubah Data Voucher</h2>
                                             ...
                                             <form action="{{ route('voucher.update') }}" method="POST">
                                                 ...
                                                 <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                     ...
                                                     <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
                                                             class="form-label">Kode Voucher</label>
                                                         <input id="modal-form-1" type="text" value="{{ $item->kode }}"
                                                     ...
                                                     <div class="col-span-12 sm:col-span-12"> <label for="modal-form-2"
                                                         ...
                                                         <input id="modal-form-2" type="number" name="harga"
                                         ...
                                         <div class="modal-content">
                                             <div class="modal-body p-0">
                                                 ...
                                                 <div class="px-5 pb-8 text-center">
                                                     ...
                                                     <a href="{{ route('voucher.delete', $item->id) }}" type="button"
     ...
     <div id="header-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
         <div class="modal-dialog">
             <div class="modal-content"> <!-- BEGIN: Modal Header -->
                 <div class="modal-header">
                     <h2 class="font-medium text-base mr-auto">Tambah Data Voucher</h2>

                 </div> <!-- END: Modal Header --> <!-- BEGIN: Modal Body -->
                 <form action="{{ route('voucher.create') }}" method="POST">
                     @csrf
                     <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                         <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1" class="form-label">Kode
                                 Voucher</label>
                             <input id="modal-form-1" type="text" name="kode" class="form-control"
                                 placeholder="Masukkan Kode Voucher">
                         </div>
                         <div class="col-span-12 sm:col-span-12"> <label for="modal-form-2"
                                 class="form-label">Potongan</label>
                             <input id="modal-form-2" type="number" name="harga" class="form-control"
                                 placeholder="Masukkan Potongan">
                         </div>
