                         ...
                         <tbody>
                             @foreach ($kategori as $key => $item)
                                 <tr class="intro-x">
                                     ...
                                     <td class="font-medium whitespace-nowrap">
                                         {{ \Illuminate\Support\Str::words($item->ket, 2, '...') }}
                                     </td>
                                     <td class="font-medium whitespace-nowrap">
                                             ...
                                             <form action="{{ route('kategori.update') }}" method="POST"
                                                 ...
                                                 <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                     ...
                                                     <div class="col-span-12 sm:col-span-12"> <label for="modal-form-2"
                                                         ...
                                                         <textarea class="form-control" name="ket" id="" cols="20" rows="10"> {{ $item->ket }} </textarea>
                                         ...
                                         <div class="modal-content">
                                             <div class="modal-body p-0">
                                                 ...
                                                 <div class="px-5 pb-8 text-center">
                                                     ...
                                                     <a href="{{ route('kategori.delete', $item->id) }}" type="button"
             ...
             <div class="modal-content"> <!-- BEGIN: Modal Header -->
                 ...
                 <form action="{{ route('kategori.create') }}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                         ...
                         <div class="col-span-12 sm:col-span-12"> <label for="modal-form-2"
                                 class="form-label">Keterangan</label>
                             <textarea class="form-control" name="ket" id="" cols="20" rows="10" required>  </textarea>
