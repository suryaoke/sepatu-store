 ...
 @section('backend')
                                 ...
                                 <div class="modal-dialog">
                                     <div class="modal-content"> <!-- BEGIN: Modal Header -->
                                         <div class="modal-header">
                                             <h2 class="font-medium text-base mr-auto">Ubah Data Brands</h2>
                                     ...
                                     <div class="modal-content">
                                         <div class="modal-body p-0">
                                             ...
                                             <div class="px-5 pb-8 text-center">
                                                 ...
                                                 <a href="{{ route('brands.delete', $item->id) }}" type="button"
     ...
     <div id="header-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
         <div class="modal-dialog">
             <div class="modal-content"> <!-- BEGIN: Modal Header -->
                 <div class="modal-header">
                     <h2 class="font-medium text-base mr-auto">Tambah Data Brands</h2>

                 </div> <!-- END: Modal Header --> <!-- BEGIN: Modal Body -->
                 <form action="{{ route('brands.create') }}" method="POST" id="myForm"
                     enctype="multipart/form-data">
                     @csrf
                     <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                         <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
