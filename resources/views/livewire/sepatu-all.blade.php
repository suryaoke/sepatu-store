   <section id="latest"
       ...
       <div class="flex items-center justify-between">
           <div class="flex flex-col gap-4">
               <h2 class="font-['ClashDisplay-SemiBold'] text-5xl leading-[59px] tracking-05"> </h2>
               <p class="leading-19 tracking-03 opacity-60"><br></p>
               <p class="leading-19 tracking-03 opacity-60"><br></p>
               <p class="leading-19 tracking-03 opacity-60"><br></p>
           </div>
           <div class="flex items-center w-[47px] rounded-[53px] bg-white" style="height: 63px; padding:10px;">
               ...
               <a wire:key="{{ $item->id }}" href="{{ route('frontend.detail', $item->slug) }}" class="card">
                   <div class="flex flex-col rounded-3xl p-8 gap-6 bg-white">
                       <div class="title flex flex-col gap-2">
                           <h3 class="font-clash-display leading-19 tracking-05">{{ $item->nama }}
                           </h3>
